...
3. The compiled binary will be at `./target/release/del_empty_pngs_fast`

## Usage

Run the tool with a directory path:
```bash
./del_empty_pngs_fast /path/to/your/tiles
```

**Example:**
```bash
./del_empty_pngs_fast ~/Documents/map_tiles
```
...
4. Only print errors (runs silently on success)
